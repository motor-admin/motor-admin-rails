...
ActiveRecord::Schema.define(version: 20_200_714_081_950) do
  ...
  create_table 'motor_alerts', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index 'lower((name)::text)', name: 'motor_alerts_lower_name_unique_index', unique: true,
  ...
  create_table 'motor_dashboards', force: :cascade do |t|
    ...
    t.index 'lower((title)::text)', name: 'motor_dashboards_lower_title_unique_index', unique: true,
                                    where: '(deleted_at IS NULL)'
  end
  ...
  create_table 'motor_forms', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index 'lower((name)::text)', name: 'motor_forms_lower_name_unique_index', unique: true,
                                   where: '(deleted_at IS NULL)'
  ...
  create_table 'motor_queries', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index 'lower((name)::text)', name: 'motor_queries_lower_name_unique_index', unique: true,
                                   where: '(deleted_at IS NULL)'
  end
  ...
  create_table 'motor_tags', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index 'lower((name)::text)', name: 'motor_tags_lower_name_unique_index', unique: true
  end
